<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=800&size=28&pause=1000&color=3B82F6&center=true&vCenter=true&random=false&width=900&lines=AI+Police+Assistance+System+%E2%80%94+AIPAS+v3.0;Enterprise+AI-Powered+Digital+Policing+Platform;React+%E2%80%A2+FastAPI+%E2%80%A2+LangGraph+%E2%80%A2+PostgreSQL;Built+for+Smart+Law+Enforcement+%F0%9F%8F%9B%EF%B8%8F" alt="Typing SVG" />
</p>
...
<p align="center">
  <img src="https://img.shields.io/badge/React-19.0-61DAFB?style=for-the-badge&logo=react&logoColor=black&labelColor=1F2937" />
  <img src="https://img.shields.io/badge/TypeScript-5.0-3178C6?style=for-the-badge&logo=typescript&logoColor=white&labelColor=1F2937" />
  <img src="https://img.shields.io/badge/Vite-6.0-646CFF?style=for-the-badge&logo=vite&logoColor=white&labelColor=1F2937" />
  <img src="https://img.shields.io/badge/FastAPI-0.110-009688?style=for-the-badge&logo=fastapi&logoColor=white&labelColor=1F2937" />
  <img src="https://img.shields.io/badge/PostgreSQL-15-4169E1?style=for-the-badge&logo=postgresql&logoColor=white&labelColor=1F2937" />
  <img src="https://img.shields.io/badge/Docker-Enabled-2496ED?style=for-the-badge&logo=docker&logoColor=white&labelColor=1F2937" />
  <img src="https://img.shields.io/badge/OpenAI-GPT--4o-412991?style=for-the-badge&logo=openai&logoColor=white&labelColor=1F2937" />
  <img src="https://img.shields.io/badge/LangGraph-Agentic-FF6F61?style=for-the-badge&labelColor=1F2937" />
</p>
...
```mermaid
graph TD
    subgraph Client["🖥️ React 19 Frontend (Vite SPA)"]
        A[Citizen Portal] 
        B[Officer Dashboard]
        C[Admin Console]
    end
    ...
    subgraph AI["🧠 AI & Intelligence Layer"]
        ...
        I[FAISS RAG Vector Index]
        J[Entity Extractor / NER]
    end
...
```mermaid
flowchart TD
    A([👤 Citizen Submits Complaint]) --> B[/Complaint Intake Queue/]
    B --> C{AI Triage Engine}
    C -->|Entity Extraction + BNS RAG| D[Supervisor Review]
    D -->|Approved| E[FIR Generated]
    D -->|Rejected| F([Citizen Notified])
    E --> G[Investigation Assigned]
    G --> H[Evidence Uploaded & Hashed]
    H --> I[AI Copilot Analysis]
    I --> J[Chargesheet Drafted]
    J --> K[Court Hearing Scheduled]
    K --> L{Verdict}
    L -->|Convicted| M([Case Archived])
    L -->|Acquitted| M
    L -->|Appeal| K
```
...
```mermaid
graph LR
    A[API Request] --> B{JWT Middleware}
    B -->|Invalid Token| C[401 Unauthorized]
    B -->|Valid Token| D{RBAC Check}
    D -->|Permission Denied| E[403 Forbidden]
    D -->|Granted| F[Business Logic]
    F --> G[Audit Log Write]
    G --> H[Response]
```
